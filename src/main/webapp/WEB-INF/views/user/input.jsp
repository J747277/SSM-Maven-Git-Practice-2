...
<form:form action="/user/saveOrUpdate" modelAttribute="user" enctype="multipart/form-data">
    ...
    密码<form:password path="password" showPassword="true" required="true"/><form:errors path="password"
                                                                                       cssStyle="color: red"/><br/>
    入职<form:input path="bornDate"/><br/>
    薪资<form:input path="salary"/><br/>
    权限<form:select path="gradeId.id" items="${grades}" itemLabel="gradeName" itemValue="id"/><br/>
